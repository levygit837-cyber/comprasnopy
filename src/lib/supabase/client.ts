 ...
 * NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY are configured. Components that need
 * auth (popover, account pages) should check this before mounting so the
 * build works without credentials.
 */
